...
class Pokedex {
    ...
    async dibujarPokedex(data) {
        ...
        for (let i = 0; i < Pokemon.length; i++) {
            ...
            body.setAttribute("class", "container-fluid d-flex flex-wrap justify-content-center"); //seteamos clases en el body
            ...
            switch (Pokemon[i].color) {
                case "green":
                    card_container.setAttribute("class", "card rounded-4 fondo-verde mx-3 my-3 shadow-moved");
                    break;
                case "red":
                    card_container.setAttribute("class", "card rounded-4 fondo-rojo mx-3 my-3 shadow-moved");
                    break;
                case "blue":
                    card_container.setAttribute("class", "card rounded-4 fondo-azul mx-3 my-3 shadow-moved");
                    break;
                case "white":
                    card_container.setAttribute("class", "card rounded-4 fondo-blanco mx-3 my-3 shadow-moved");
                    break;
                case "brown":
                    card_container.setAttribute("class", "card rounded-4 fondo-cafe mx-3 my-3 shadow-moved");
                    break;
                case "yellow":
                    card_container.setAttribute("class", "card rounded-4 fondo-amarillo mx-3 my-3 shadow-moved");
                    break;
                case "purple":
                    card_container.setAttribute("class", "card rounded-4 fondo-morado mx-3 my-3 shadow-moved");
                    break;
                case "pink":
                    card_container.setAttribute("class", "card rounded-4 fondo-rosado mx-3 my-3 shadow-moved");
                    break;
                case "gray":
                    card_container.setAttribute("class", "card rounded-4 fondo-gris mx-3 my-3 shadow-moved");
                    break;
                case "black":
                    card_container.setAttribute("class", "card rounded-4 fondo-negro mx-3 my-3 shadow-moved");
                    break;
                default:
                    break;
            }
